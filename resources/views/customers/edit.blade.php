...
<div class="max-w-2xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <form method="POST" action="{{ route('customers.update', $customer) }}" class="bg-white shadow rounded-lg p-6 space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end space-x-3 pt-4">
            ...
            <button type="submit"
                    class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">Perbarui</button>
        </div>
    </form>
</div>
@endsection